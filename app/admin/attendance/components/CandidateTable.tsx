      ...
      <table className="min-w-full text-sm">
        <thead className="bg-brown-800/60 border-b border-brown-700">
          <tr className="text-left text-[10px] uppercase tracking-wider text-cream-400 font-mono">
            ...
            <th className="px-3 py-2 font-normal text-right">Effort</th>
            <th className="px-3 py-2 font-normal">Last touch</th>
          ...
          {sorted.map((r) => {
            ...
            return (
              ...
              >
                ...
                <td className="px-3 py-2"><StatusPill status={r.outreachStatus} /></td>
                <td className="px-3 py-2">
                  {r.owner ? (
                ...
                <td className="px-3 py-2 text-right font-mono text-cream-100">
                  {r.realBits > 0 ? (
                ...
                <td className="px-3 py-2 text-xs text-cream-200 max-w-xs">
